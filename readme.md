...
![Top Clientes](shoesbr/docs/images/top_clientes_total_gasto.png)

### 📦 Top 10 Produtos por Total Faturado

Visualização dos produtos com maior faturamento total.

![Top Produtos](shoesbr/docs/images/top_produtos_faturamento.png)
...
![Top Receita Líquida](shoesbr/docs/images/top5_receita_liquida_produto_pagamento.png)
